...
SERVER_IP = "websockets.cerealis.cloud"
RGB_FEED_URL = f"wss://{SERVER_IP}/ws/rgb_feed"
DEPTH_FEED_URL = f"wss://{SERVER_IP}/ws/depth_feed"
CONTROL_URL = f"wss://{SERVER_IP}/ws/control"
INFO_URL = f"wss://{SERVER_IP}/ws/drone_info"
